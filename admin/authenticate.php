...
// Uses a prepared statement + password_verify() — never plain text.
// ============================================================
...
// Trim inputs (do NOT sanitize yet — we compare hash, not raw string in DB)
$username = trim($_POST['username'] ?? '');
$password = trim($_POST['password'] ?? '');

// Basic presence check — avoid hitting the DB with obviously empty fields
...
// Using password_verify() — never compare plain text
